...
const std::string syscalls[] = {
  ...
  "nfsservctl", "getpmsg", "putpmsg", "afs_", "tuxcall", "security", "gettid",
  ...
  "getdents64", "set_tid_address", "restart_", "semtimedop", "fadvise64",
  ...
  "vserver", "mbind", "set_mempolicy", "get_mempolicy", "mq_open", "mq_unlink",
